...
RSpec.describe DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser do
  ...
  let(:dsl_execution) { BaseClass.dsls.class_dsl_executions(ChildClass, :dsl_name).first }

  describe :initialize do
    it "initializes the class without error" do
      expect {
        DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :method_name do
        end
      }.to_not raise_error
    end
    ...
    it "raises an error if the provided method name does exist within the scoped DSLs" do
      expect {
        DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :unexpected_method_name do
        end
    ...
    it "raises an error if a block is not provided to the initializer" do
      expect {
        DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :method_name
    ...
    it "raises an error if the provided block has unexpected argument types" do
      expect {
        DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :method_name do |unexpected_argument|
        end
    ...
    it "raises an error if the provided block has unexpected keyword arguments" do
      expect {
        DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :method_name do |unexpected_keyword_argument:|
        end
    ...
    it "optionally passes the method_name to the provided block" do
      mn = nil
      DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :method_name do |method_name:|
        mn = method_name
      end
    ...
    it "optionally passes method argument values to the provided block" do
      method_an = nil
      DSLCompose::Parser::ForChildrenOfParser::ForDSLParser::ForMethodParser.new BaseClass, ChildClass, dsl_execution, :method_name do |method_arg_name:|
