...
RSpec.describe DSLCompose::DSL::Arguments::Argument::GreaterThanOrEqualToValidation do
  describe :initialize do
    it "initializes a new GreaterThanOrEqualToValidation without raising any errors" do
      expect {
        DSLCompose::DSL::Arguments::Argument::GreaterThanOrEqualToValidation.new 100
      }.to_not raise_error
    end
    ...
    it "raises an error if initializing the GreaterThanOrEqualToValidation with a string instead of a number" do
      expect {
        DSLCompose::DSL::Arguments::Argument::GreaterThanOrEqualToValidation.new "100"
      }.to raise_error(DSLCompose::DSL::Arguments::Argument::GreaterThanOrEqualToValidation::InvalidValueError)
    end

    describe :validate do
      let(:greater_than_or_equal_to_validation) { DSLCompose::DSL::Arguments::Argument::GreaterThanOrEqualToValidation.new 100 }
