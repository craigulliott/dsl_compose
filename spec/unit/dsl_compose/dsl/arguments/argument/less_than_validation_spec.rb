...
RSpec.describe DSLCompose::DSL::Arguments::Argument::LessThanValidation do
  describe :initialize do
    it "initializes a new LessThanValidation without raising any errors" do
      expect {
        DSLCompose::DSL::Arguments::Argument::LessThanValidation.new 100
      }.to_not raise_error
    end
    ...
    it "raises an error if initializing the LessThanValidation with a string instead of a number" do
      expect {
        DSLCompose::DSL::Arguments::Argument::LessThanValidation.new "100"
      }.to raise_error(DSLCompose::DSL::Arguments::Argument::LessThanValidation::InvalidValueError)
    end

    describe :validate do
      let(:less_than_validation) { DSLCompose::DSL::Arguments::Argument::LessThanValidation.new 100 }
