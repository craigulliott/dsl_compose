...
RSpec.describe DSLCompose::DSL::Arguments::Argument::GreaterThanValidation do
  describe :initialize do
    it "initializes a new GreaterThanValidation without raising any errors" do
      expect {
        DSLCompose::DSL::Arguments::Argument::GreaterThanValidation.new 100
      }.to_not raise_error
    end
    ...
    it "raises an error if initializing the GreaterThanValidation with a string instead of a number" do
      expect {
        DSLCompose::DSL::Arguments::Argument::GreaterThanValidation.new "100"
      }.to raise_error(DSLCompose::DSL::Arguments::Argument::GreaterThanValidation::InvalidValueError)
    end

    describe :validate do
      let(:greater_than_validation) { DSLCompose::DSL::Arguments::Argument::GreaterThanValidation.new 100 }
